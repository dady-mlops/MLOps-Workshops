...
def main():
    ...
    if args.no_auth:
        if not args.url:
            print("Error: --url is required when using --no-auth")
            return False
...
# Example usage:
# python test_model.py --endpoint yolov8-serverless-endpoint --image car.jpg --save my_result.jpg --region us-east-2
# 
# Or with full URL (not recommended, but will extract endpoint name and region automatically):
